...
const en = {
  ...
  // party / lobby
  party: "Party",
  partyManage: "Tap to manage party",
  ...
  partyOpen: "Open",
  partyClosed: "Closed",
  accessibility: "Party access",
  findMatch: "Find match",
  searching: "Searching…",
  cancelSearch: "Cancel search",
  matchFoundShort: "Match found",
  leaveParty: "Leave party",
  kick: "Kick",
  owner: "Owner",
  ownerOnlyHint: "Only the party owner can start a match or change settings.",
  queue: "Queue",
  qCompetitive: "Competitive",
  qUnrated: "Unrated",
  qSwiftplay: "Swiftplay",
  qSpikeRush: "Spike Rush",
  qDeathmatch: "Deathmatch",
  qTeamDeathmatch: "Team Deathmatch",
  // in-match scoreboard
  teamAlly: "Your team",
  teamEnemy: "Enemy",
  statKd: "K/D",
...
const vi: Bundle = {
  ...
  aOpen: "trống",
  party: "Nhóm",
  partyManage: "Chạm để quản lý nhóm",
  partyMembers: "Thành viên",
  inviteCode: "Mã mời",
  noInviteCode: "Chưa có mã mời",
  generateCode: "Tạo mã",
  disableCode: "Tắt mã",
  copy: "Sao chép",
  copied: "Đã chép",
  joinByCode: "Vào bằng mã",
  joinCodePlaceholder: "Nhập mã",
  join: "Vào",
  partyOpen: "Mở",
  partyClosed: "Đóng",
  accessibility: "Quyền vào nhóm",
  findMatch: "Tìm trận",
  searching: "Đang tìm…",
  cancelSearch: "Hủy tìm",
  matchFoundShort: "Đã tìm thấy",
  leaveParty: "Rời nhóm",
  kick: "Đuổi",
  owner: "Chủ nhóm",
  ownerOnlyHint: "Chỉ chủ nhóm mới được tìm trận hoặc đổi cài đặt.",
  queue: "Chế độ",
  qCompetitive: "Xếp hạng",
  qUnrated: "Đấu thường",
  qSwiftplay: "Đấu nhanh",
  qSpikeRush: "Spike Rush",
  qDeathmatch: "Đấu tay đôi",
  qTeamDeathmatch: "Đấu đội",
  teamAlly: "Đội bạn",
  teamEnemy: "Đối thủ",
  statKd: "K/D",
  statAdr: "ADR",
