...
function makeState(s: Session) {
  ...
  return {
    ...
    data: {
      ...
      teammates: inSelect
        ? [
            { name: "You", agent_uuid: s.selfAgent, status: s.selfStatus, self: true, party_group: 1,
              stats: stat("You", 19, 24, 1.21, 158, 28.0, 52, [true, false, true, true, false]) },
            { name: "wazuu#1406", agent_uuid: SAGE, status: "locked", self: false, party_group: 1,
              stats: stat("wazuu#1406", 19, 20, 1.46, 194, 22.0, 45, [true, true, false, true, true]) },
            { name: "Nova#NOVA", agent_uuid: PHOENIX, status: "selected", self: false, party_group: 0,
              stats: stat("Nova#NOVA", 14, 16, 0.57, 96, 9.1, 36, [false, false, true, false, false]) },
            { name: "K2#000", agent_uuid: "", status: "", self: false, party_group: 0, stats: null },
            { name: "Echo#001", agent_uuid: "", status: "", self: false, party_group: 0, stats: null },
          ]
        : [],
